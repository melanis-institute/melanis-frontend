import { MessageCircleMore, SearchCheck, Upload } from "lucide-react";
import { useNavigate } from "react-router";
import { useAuth } from "../../auth/useAuth";

const MODULES = [
  {
    title: "Demande d'avis dermato",
    description: "Création structurée de demandes d'avis inter-praticiens.",
    icon: SearchCheck,
  },
  {
    title: "Pièces jointes",
    description: "Upload sécurisé de médias et contexte clinique.",
    icon: Upload,
  },
  {
    title: "Suivi des réponses",
    description: "Thread des réponses et statuts asynchrones.",
        ...
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-[rgba(17,18,20,0.62)]">
              Espace d'avis inter-praticiens prêt en mode scaffold.
            </p>
          </div>
          <button

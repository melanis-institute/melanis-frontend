...
import {
  AcneIllustration,
  ChuteDeCheveuxIllustration,
  EczemaIllustration,
  GrainsDeBeauteIllustration,
  InfectionIllustration,
  RougeursIllustration,
  TachesIllustration,
} from "@portal/shared/generated";
import { MOTIFS } from "./types";

const ICONS: Record<string, React.ReactNode> = {
  acne: <div className="w-[28px] h-[28px]"><AcneIllustration /></div>,
  taches: <div className="w-[28px] h-[28px]"><TachesIllustration /></div>,
  eczema: <div className="w-[28px] h-[28px]"><EczemaIllustration /></div>,
  rougeurs: <div className="w-[28px] h-[28px]"><RougeursIllustration /></div>,
  cheveux: <div className="w-[28px] h-[28px]"><ChuteDeCheveuxIllustration /></div>,
  mycose: <div className="w-[28px] h-[28px]"><InfectionIllustration /></div>,
  grain: <div className="w-[28px] h-[28px]"><GrainsDeBeauteIllustration /></div>,
